    ...
    <div class="grid lg:grid-cols-[.8fr_1.2fr] gap-4 items-stretch">
        <div data-reveal data-reveal-delay="1" class="bg-[#D4DC24] rounded-[2rem] rounded-br-[3rem] p-6 sm:p-8 flex flex-col justify-between">
            <div>
                ...
                <p class="text-sm/6 text-[#1E2412]/70 mt-4">Format simple: kirim brief, kami cek, harga dikunci, produksi jalan.</p>
            </div>
            <a href="https://wa.me/6285885928506?text=Halo%20Anugerah%20Printer,%20saya%20ingin%20request%20penawaran%20harga" target="_blank" rel="noopener" class="mt-8 inline-flex w-max items-center gap-2 bg-[#1E2412] text-white rounded-full px-5 py-3 text-sm font-bold">Mulai Quote <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M5 12h14m-6-6 6 6-6 6"/></svg></a>
        </div>
        ...
        <div data-reveal data-reveal-delay="2" class="bg-[#EFECD8] border border-[#1E2412]/10 rounded-[2rem] rounded-tl-[3rem] p-5 sm:p-6">
            ...
            <div class="divide-y divide-[#1E2412]/10">
                ...
                <div class="grid sm:grid-cols-[64px_1fr] gap-3 py-4"><span class="font-anton text-3xl text-[#1E2412]/20">03</span><div><h3 class="font-bold text-[#1E2412]">Harga dikunci setelah cocok</h3><p class="text-sm/5 text-[#62684A] mt-1">Estimasi transparan sesuai bahan, finishing, dan volume.</p></div></div>
